...
#define USB_CFG_IOPORTNAME      B      // attiny
/* This is the port where the USB bus is connected. When you configure it to
 * "B", the registers PORTB, PINB and DDRB will be used.
 */
#define USB_CFG_DMINUS_BIT      1	// attiny
/* This is the bit number in USB_CFG_IOPORT where the USB D- line is connected.
 * This may be any bit in the port.
 */
#define USB_CFG_DPLUS_BIT       2	// attiny
/* This is the bit number in USB_CFG_IOPORT where the USB D+ line is connected.
 ...
 */
#define USB_CFG_VENDOR_NAME     'j','o','h','a','n','n','e','s','.','k','n','e','e','r','@','g','m','a','i','l','.','c','o','m'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'I', 'R', '-', 'S', 'e', 'n', 'd'
